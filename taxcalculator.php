...
<head>
    ...
    <style type="text/css">
        ...
        body {
            ...
            color: #black;
            background: linear-gradient(to right, #33ccff -61%, #669999 100%);
            font-size: 21px;
            text-align: center;
        }
...
<body>
    ...
    <center>
        ...
        <form method="post">
        <center> <img src="https://www.pinoymoneytalk.com/wp-content/uploads/2020/06/income-tax-tables-train-philippines-2018-2022.png" ; width="650" height="450" ; border="5" id="img"> </center>
            <p>Salary:
